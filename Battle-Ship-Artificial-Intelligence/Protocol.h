 ...
 *   $ <- dollar sign
 *   MSGID <- a 3-5 character message ID                         \
 *   , <- Separates the message ID from the data that follows it | - All of this together is the payload
